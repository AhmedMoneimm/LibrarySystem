...
public class TestLibrarianRole {
    ...
    public static void test1() {
        ...
        ArrayList<Record> books = librarian.getListOfBooks();
        ...
        System.out.println("Current number of books = " + books.size());
        ArrayList<Record> borrowingOperations = librarian.getListOfBorrowingOperations();
        System.out.println("Current number of ongoing borrowing operations = " + borrowingOperations.size());
    ...
    public static void main(String[] args) {
        System.out.println("--------------Test Librarian--------------\n");
        test1();
        System.out.println("------------------------------------------------------------------\n");
        test2();
